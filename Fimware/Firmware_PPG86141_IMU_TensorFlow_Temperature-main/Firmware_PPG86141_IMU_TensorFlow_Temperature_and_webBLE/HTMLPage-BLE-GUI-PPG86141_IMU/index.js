...
async function LEDSEQ1A_PD1CHARACTERISTIC2Changed(event) {
  ...
  const data3 = (value.getUint8(12) << 24) | (value.getUint8(13) << 16) | (value.getUint8(14) << 8) | value.getUint8(15); // shifts 4 Uint8 to make a Uint32
  const data4 = (value.getUint8(16) << 24) | (value.getUint8(17) << 16) | (value.getUint8(18) << 8) | value.getUint8(19); // shifts 4 Uint8 to make a Uint32

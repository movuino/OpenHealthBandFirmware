  ...
  try{
   ...
   if(characteristic.uuid== '00001104-0000-1000-8000-00805f9b34fb'){
    ...
    var x = (((value.getInt8(5)<<8) | value.getInt8(4)) * mag_resolution * mag_bias_factory_0 - mag_bias_0 * bias_to_current_bits) * mag_scale_0;
    var y = (((value.getInt8(7)<<8) | value.getInt8(6)) * mag_resolution * mag_bias_factory_1 - mag_bias_1 * bias_to_current_bits) * mag_scale_1;
    var z = (((value.getInt8(9)<<8) | value.getInt8(8)) * mag_resolution * mag_bias_factory_2 - mag_bias_2 * bias_to_current_bits) * mag_scale_2;

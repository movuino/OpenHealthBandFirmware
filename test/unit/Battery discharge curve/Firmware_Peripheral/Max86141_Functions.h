...
//////////////// battery /////////////////////////////
#include "Ticker.h"
uint32_t vbat_pin = 18;//PIN_VBAT;             // A7 for feather nRF52832, A6 for nRF52840
...
void updatePPG86(void) {
  ...
  if (flagA_full) {
    ...
    //int levelBat = vbat_per;
    //Serial.println("levelBat: "+String(levelBat));
    pulseOx1.tab_ledSeq1A_PD1[0]= vbat_mv * 100;

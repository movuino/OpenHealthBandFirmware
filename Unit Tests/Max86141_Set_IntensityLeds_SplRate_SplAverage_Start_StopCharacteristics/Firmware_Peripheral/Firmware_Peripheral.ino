...
Serial.println("Reçu: "+String(StartCharacteristic.read8()));
    ...
    if (StartCharacteristic.read8() == 1) { //Received 1 from Central to start sending data
    ...
    /* if((intensityLedsCharacteristic.read8()!=0)  && (smplRateCharacteristic.read8()!=0) && (smplAvgCharacteristic.read8()!=0)){

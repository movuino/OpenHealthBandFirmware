...
BLECharacteristic intensityLedsCharacteristic = BLECharacteristic(0x1315);
BLECharacteristic smplRateCharacteristic = BLECharacteristic(0x1316);
BLECharacteristic smplAvgCharacteristic = BLECharacteristic(0x1317);

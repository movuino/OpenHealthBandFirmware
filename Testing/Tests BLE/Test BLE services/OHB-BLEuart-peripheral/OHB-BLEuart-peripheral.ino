...
void loop()
{
 ...
 //  Serial.println("MTU"+ String (data_mtu));
 /*for(int i=0;i<=63;i++) buf[i]=counter;
  // Serial.println("sending" + String(buf[0])); 

   Serial.println(String (millis()-timer0) +" "+String(counterG)); 
 
   bleuart.write(buf, 64 );
   delay(1);
